...
<body>
    ...
    $pesquisa->registarEstagio($_GET["empresa"],$_GET["estabelecimento"],$_GET["aluno"],$_GET["formador"],$_GET["data_inicio"]);
    $pesquisa->fecharPesquisa();
    ?>
    </div>
    </center> 
    <div class="botoes">
        <input class = "butao" type="button" value="Novo Registo" onclick = "window.location = 'registar.php'">
